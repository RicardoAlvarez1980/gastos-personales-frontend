...
export default function FormularioAgregarGasto({
  ...
  const servicioSeleccionado = servicios.find(
    s => String(s.id) === String(nuevoGasto.servicio_id)
  )
    ...
    <form onSubmit={handleSubmit} style={{ backgroundColor: colores.fondoForm, padding: 20, borderRadius: 8 }}>
      ...
      <div style={{ marginBottom: 10 }}>
        ...
        <select
          ...
          style={{ ...estiloSelect, opacity: !nuevoGasto.año ? 0.65 : 1 }}
        >
          ...
          >
            <span style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
              {servicioSeleccionado && (
                <span
                  ...
                  style={{
                    ...
                    height: 10,
                    borderRadius: 2,
                    backgroundColor: servicioSeleccionado.color || '#999',
              ...
              <span style={{ color: servicioSeleccionado ? '#222' : '#64748b' }}>
                {servicioSeleccionado
                  ? formatearNombreServicio(servicioSeleccionado.nombre)
            ...
            >
              <button
                ...
                style={{
                  width: '100%',
                  border: 'none',
                  background: !nuevoGasto.servicio_id ? '#f1f5f9' : 'transparent',
                  borderRadius: 5,
                  padding: '9px 10px',
                  textAlign: 'left',
                  color: '#64748b',
